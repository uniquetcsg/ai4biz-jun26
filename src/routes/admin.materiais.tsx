    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-5xl px-6 py-16">
        <div className="mb-12">
          ...
          <p className="mt-2 text-base text-muted-foreground">Selecione o tópico e o tipo de material</p>
        </div>
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col items-center justify-center gap-4 border-2 border-dashed border-primary bg-card px-6 py-16">
                <div className="flex h-16 w-16 items-center justify-center bg-segment">
                  <ActiveIcon className="h-8 w-8 text-segment-foreground" />
                </div>
